...
function InstaEmbed({ url, maxWidth = 260 }) {
  return (
    <iframe
      src={`${url}embed/`}
      width={maxWidth}
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll(".js-heading").forEach((el) => io.observe(el));
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="btn-premium px-4 sm:px-6 py-2 sm:py-2.5 bg-gray-900 text-white rounded-lg text-sm sm:text-base font-medium hover:bg-gray-800 transition-all hover:shadow-xl min-h-[44px] flex items-center justify-center"
      ...
      <section className="relative min-h-[88vh] flex items-center pt-24 hero-bg">
        ...
        <div className="absolute inset-0 lg:hidden bg-gradient-to-b from-white/40 via-transparent to-transparent pointer-events-none" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-2xl">
            <h1 className="js-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight mb-4 sm:mb-5 hero-text-shadow" style={{color: '#0B0B0C'}}>
            ...
            <div className="result-subtitle mb-4 sm:mb-5">
              <div className="hero-subtitle-bg">
                <p className="text-base sm:text-lg lg:text-xl font-medium leading-relaxed" style={{color: '#1a202c'}}>
                  Проверенная система общения с клиентами для бьюти-мастеров
                </p>
              </div>
            </div>

            <p className="text-sm sm:text-base lg:text-lg text-gray-900 mb-6 sm:mb-8 leading-relaxed hero-subtitle-bg" style={{display: 'inline-block'}}>
              <span className="font-semibold italic">Результат:</span> закрытые возражения, увеличенный средний чек, экономия времени
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="btn-premium inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-7 py-3 sm:py-3.5 lg:py-4 bg-gray-900 text-white rounded-xl text-base sm:text-lg font-semibold hover:bg-gray-800 transition-all hover:shadow-2xl min-h-[48px]"
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-gray-900">
              <span className="px-2 py-1 bg-white/90 rounded border border-gray-300">🔒 Безопасная оплата</span>
              <span className="px-2 py-1 bg-white/90 rounded border border-gray-300">✓ Stripe</span>
            </div>
          </div>
        </div>
      ...
      <section id="comparison" className="relative py-12 sm:py-14 lg:py-16 premium-bg-gray">
        <SectionMarker n="01" />
      ...
      <section id="why" className="relative py-12 sm:py-14 lg:py-16 premium-bg-white">
        <SectionMarker n="02" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center">
            <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
              Почему это <span className="text-dusty-rose">важно</span>
            </h2>
            <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-600 reveal-up" style={{animationDelay:"120ms"}}>
      ...
      <section id="for" className="relative py-12 sm:py-14 lg:py-16 bg-gradient-to-br from-emerald-50/20 via-teal-50/15 to-cyan-50/20">
        <SectionMarker n="03" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900">
            Кому подходят <span className="text-dusty-green">скрипты</span>
          </h2>
      ...
      <section id="whats-included" className="relative py-12 sm:py-14 lg:py-16 premium-bg-white">
        <SectionMarker n="04" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center">
            <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
            ...
            {[
              ...
              <div key={k} className="rounded-xl sm:rounded-2xl border p-3 sm:p-4 lg:p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:`${k*80}ms`}}>
                <img 
                  ...
                  style={item.img.includes('rocket') ? {transform: 'scale(1.2)'} : {}}
                  loading="lazy" 
                />
      ...
      <section id="bonuses" className="relative py-12 sm:py-14 lg:py-16 bg-gradient-to-br from-blue-50/20 via-rose-50/15 to-amber-50/20 overflow-hidden">
        <SectionMarker n="05" />
      ...
      <section id="immediate" className="relative py-12 sm:py-14 lg:py-16 premium-bg-gray">
        <SectionMarker n="06" />
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900">
            <span className="text-dusty-teal">Что изменится сразу</span>
          </h2>
          ...
          <div className="space-y-4 sm:space-y-5 mt-6 sm:mt-8">
            {[
              ...
              <div key={i} className="flex items-start gap-3 sm:gap-4 bg-white p-4 sm:p-5 rounded-xl sm:rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:`${i*80}ms`}}>
      ...
      <section id="reviews" className="relative py-12 sm:py-14 lg:py-16 premium-bg-white">
        <SectionMarker n="07" />
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-gradient-to-br from-gray-50/80 to-white/80 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-lg border border-gray-200/50">
              ...
              {[1, 2, 3, 4].map((n) => (
                <div key={n} className="group cursor-pointer reveal-up" style={{animationDelay:`${n*60}ms`}}>
                  <img
                    ...
                    alt={`Отзыв ${n}`}
                    className="w-full h-48 sm:h-56 lg:h-64 object-cover rounded-xl sm:rounded-2xl border-2 border-gray-200/60 hover:border-blue-300/60 hover:shadow-2xl transition-all duration-500 group-hover:scale-[1.03]"
            ...
            <div className="flex gap-3 sm:gap-4 justify-center items-start mb-0 overflow-x-auto pb-2 reels-row">
              {INSTAGRAM_REELS.map((url, idx) => (
                <div
                  key={url}
                  className="reel-card rounded-xl overflow-hidden border-2 border-gray-300/60 shadow-lg flex-shrink-0 hover:shadow-2xl hover:scale-[1.03] hover:border-blue-300/70 transition-all duration-500"
      ...
      <section id="offer" className="relative py-12 sm:py-14 lg:py-16 premium-bg-gray">
        <SectionMarker n="08" />
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="max-w-lg mx-auto">
            <div className="rounded-2xl sm:rounded-3xl p-6 sm:p-8 bg-slate-800 text-white shadow-2xl relative overflow-hidden hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] reveal-up">
              ...
              <div className="relative z-10">
                <div className="text-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className="btn-premium block w-full text-center rounded-xl bg-blue-500 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 hover:bg-blue-600 transition-all shadow-lg hover:shadow-2xl mb-3 sm:mb-4 min-h-[48px]"
      ...
      <section id="faq" className="relative py-12 sm:py-14 lg:py-16 premium-bg-white">
        <SectionMarker n="09" />
      ...
      {showStickyCTA && (
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 z-50 lg:hidden shadow-2xl animate-slide-up">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="btn-premium w-full bg-gray-900 text-white py-3 px-4 rounded-xl font-semibold text-sm text-center block hover:bg-gray-800 transition-all flex items-center justify-between min-h-[48px]"
            aria-label="Купить скрипты за 19 евро"
          >
      ...
      <style>{`
        ...
        * {
        ...
        .premium-bg-gray::before {
          content: '';
          position: absolute;
          inset: 0;
          background-image: 
            radial-gradient(circle at 20% 30%, rgba(229, 231, 235, 0.3) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(243, 244, 246, 0.4) 0%, transparent 50%);
          pointer-events: none;
        }
