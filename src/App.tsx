...
function SectionMarker({ n }: { n: string }) {
  return (
    <div 
      className="absolute left-4 top-6 flex items-center gap-2 z-10 lg:left-0 lg:top-1 lg:-translate-x-14 lg:gap-2.5"
      aria-hidden="true"
    >
      <span className="font-bold text-[11px] tracking-wider text-gray-400 lg:text-xs">{n}</span>
      <span className="inline-block w-6 h-px bg-gradient-to-r from-amber-400/40 to-transparent lg:w-9" />
    </div>
  );
}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-2xl">
            <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/50">
              ...
              <div className="relative pt-3 mt-2 mb-4 sm:mb-5 before:content-[''] before:absolute before:top-0 before:left-0 before:w-[60px] before:h-0.5 before:bg-gradient-to-r before:from-amber-500/60 before:to-transparent">
      ...
      <section id="reviews" className="relative py-12 sm:py-14 lg:py-16 premium-bg-6">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 premium-shadow">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center items-start overflow-x-auto pb-2 snap-x snap-mandatory">
              {INSTAGRAM_REELS.map((url, idx) => (
                <div
                  key={url}
                  className="reel-card rounded-2xl overflow-hidden border-2 border-gray-200 shadow-md flex-shrink-0 hover:shadow-xl hover:scale-[1.02] hover:border-amber-300 transition-all duration-300 snap-center"
