...
<style jsx>{`.section-marker{ position:absolute;  left: 1rem;  top: 1.5rem; display:flex;  align-items:center;  gap:8px; z-index: 10; } @media (min-width: 1024px){ .section-marker{ left:0;  top:0.25rem; transform: translateX(-56px); gap:10px; } } .marker-number{ font-weight:700;  font-size:11px;  letter-spacing:.12em; color: rgba(168, 181, 192, 0.7); } @media (min-width: 1024px){ .marker-number{ font-size:12px; } } .marker-line{ display:inline-block;  width:24px;  height:1px; background: linear-gradient(90deg, rgba(212, 175, 122, 0.4) 0%, transparent 100%); } @media (min-width: 1024px){ .marker-line{ width:36px; } }`}</style>
</div>
);
}
...
<div
className=“h-full bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 transition-all duration-300”
...
`<span class="accent-text font-semibold">${ph}</span>`
);
}
...
`<span class="accent-text font-semibold">${p}</span>`
);
}
...
```
  ...
  <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="px-4 sm:px-6 py-2 sm:py-2.5 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white rounded-lg text-sm sm:text-base font-medium hover:shadow-lg transition-all hover:scale-105 transform min-h-[44px] flex items-center justify-center"
  ...
  <section className="relative min-h-[88vh] flex items-center pt-24 hero-bg">
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
      <div className="max-w-2xl">
        <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/50">
          <h1 className="js-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-4 sm:mb-5 text-gray-900">
            Скрипты, которые превращают <span className="accent-gradient">сообщения в деньги</span>
          </h1>

          <div className="result-badge mb-4 sm:mb-5">
          ...
          <div className="inline-flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-amber-50 to-orange-50 rounded-full border border-amber-200/50 mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base font-semibold text-amber-900">
              <span className="font-bold">Результат:</span> закрытые возражения, увеличенный средний чек, экономия времени
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-7 py-3 sm:py-3.5 lg:py-4 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white rounded-xl text-base sm:text-lg font-semibold hover:shadow-xl transition-all hover:-translate-y-0.5 min-h-[48px]"
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs sm:text-sm">
              ...
              <span className="px-2 py-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded">Google Pay</span>
            </div>
          </div>
    ...
    <style jsx>{`
      ...
      .result-badge::before {
        ...
        width: 60px;
        height: 2px;
        background: linear-gradient(90deg, rgba(217, 119, 6, 0.6) 0%, transparent 100%);
      }
    `}</style>
  </section>

  <section id="comparison" className="relative py-12 sm:py-14 lg:py-16 premium-bg-1">
    <SectionMarker n="01" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="text-center mb-2">
        <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
          Как изменится ваша <span className="accent-gradient">работа с клиентами</span>
        </h2>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-600 reveal-up" style={{animationDelay:"120ms"}}>
      ...
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-5 max-w-5xl mx-auto mt-6 sm:mt-8">
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-7 premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up">
          ...
          <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm lg:text-base text-gray-800">
            {[
              ...
              <li key={i} className="flex gap-2 hover:bg-red-50 p-2 sm:p-2.5 rounded-lg transition-colors">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-7 premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:"120ms"}}>
          <div className="text-center mb-4 sm:mb-5">
          ...
          <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm lg:text-base text-gray-800">
            {[
              ...
              <li key={i} className="flex gap-2 hover:bg-green-50 p-2 sm:p-2.5 rounded-lg transition-colors">
  ...
  <section id="why" className="relative py-12 sm:py-14 lg:py-16 premium-bg-2">
    <SectionMarker n="02" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="text-center">
        <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
          Почему это <span className="accent-gradient">важно</span>
        </h2>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-600 reveal-up" style={{animationDelay:"120ms"}}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mt-6 sm:mt-8">
        <div className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-5 sm:p-6 text-center premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up">
          <img
            src="/images/money.png"
            alt="Сливаются деньги"
            className="mx-auto mb-4 sm:mb-5 w-14 h-14 sm:w-16 sm:h-16 object-contain"
            loading="lazy"
          />
          <h3 className="font-bold text-sm sm:text-base mb-2">Сливаются деньги на рекламу</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">
            Платите за заявки, но конвертируете лишь 20–30%. Остальные — выброшенный бюджет.
          </p>
        </div>
        <div className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-5 sm:p-6 text-center premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:"120ms"}}>
          <img
            ...
            loading="lazy"
          />
          <h3 className="font-bold text-sm sm:text-base mb-2">Тратится время впустую</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">
            По 30–40 минут на переписку с каждым. Уходит 3–4 часа в день.
          </p>
        </div>
        <div className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-5 sm:p-6 text-center premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:"200ms"}}>
          <img
            src="/images/door.png"
            ...
            loading="lazy"
          />
          <h3 className="font-bold text-sm sm:text-base mb-2">Заявки уходят к конкуренту</h3>
          <p className="mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">
  ...
  <section id="for" className="relative py-12 sm:py-14 lg:py-16 premium-bg-3">
    <SectionMarker n="03" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-8">
        Кому подходят <span className="accent-gradient">скрипты</span>
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
        {[
          ...
          <div
            key={i}
            className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-5 sm:p-6 border-2 border-emerald-200/40 hover:border-emerald-300/60 premium-shadow hover:shadow-[0_0_25px_rgba(16,185,129,0.2)] transition-all duration-300 hover:-translate-y-0.5 reveal-up"
  ...
  <section id="whats-included" className="relative py-12 sm:py-14 lg:py-16 premium-bg-4">
    <SectionMarker n="04" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="text-center">
        <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
          Что входит в <span className="accent-gradient">систему скриптов</span>
        </h2>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-600 reveal-up" style={{animationDelay:"120ms"}}>Полный набор инструментов для увеличения продаж</p>
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mt-6 sm:mt-8">
        {[
          {
          ...
          <div key={k} className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-4 sm:p-5 premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:`${k*80}ms`}}>
            <img 
              src={item.img} 
              alt="" 
              className={`object-contain mb-3 sm:mb-4 ${item.img.includes('rocket') ? 'w-10 h-10 sm:w-12 sm:h-12' : 'w-9 h-9 sm:w-10 sm:h-10'}`}
              loading="lazy" 
            />
  ...
  <section id="bonuses" className="relative py-12 sm:py-14 lg:py-16 premium-bg-5 overflow-hidden">
    <SectionMarker n="05" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
      <div className="text-center">
        <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
          <span className="accent-gradient">Бонусы</span> при покупке
        </h2>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-gray-600 reveal-up" style={{animationDelay:"120ms"}}>Суммарная ценность — 79€. Сегодня идут бесплатно со скриптами</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mt-6 sm:mt-8">
        {[
          ...
          <div key={i} className="rounded-2xl sm:rounded-3xl p-5 sm:p-6 text-center bg-white premium-shadow hover:shadow-xl hover:-translate-y-2 transition-all duration-300 reveal-up" style={{animationDelay:`${i*100}ms`}}>
            <div className="mb-4 sm:mb-5">
              <img src={b.image} alt={`Бонус ${i + 1}`} className="w-24 h-32 sm:w-28 sm:h-36 mx-auto object-cover rounded-xl" loading="lazy" />
            </div>
            <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-2">{b.title}</h3>
            <p className="mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed mb-3">{b.desc}</p>
  ...
  <section id="immediate" className="relative py-12 sm:py-14 lg:py-16 premium-bg-2">
    <SectionMarker n="06" />
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-8">
        <span className="accent-gradient">Что изменится сразу</span>
      </h2>
      ...
      <div className="space-y-4 sm:space-y-5">
        {[
          ...
          <div key={i} className="flex items-start gap-3 sm:gap-4 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 premium-shadow hover:shadow-xl transition-all duration-300 hover:-translate-y-1 reveal-up" style={{animationDelay:`${i*80}ms`}}>
  ...
  <section id="reviews" className="relative py-12 sm:py-14 lg:py-16 premium-bg-6">
    <SectionMarker n="07" />
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-6 sm:p-8 premium-shadow">
          ...
          {[1, 2, 3, 4].map((n) => (
            <div key={n} className="group cursor-pointer reveal-up" style={{animationDelay:`${n*60}ms`}}>
              <img
                ...
                alt={`Отзыв ${n}`}
                className="w-full h-48 sm:h-56 lg:h-64 object-cover rounded-2xl border-2 border-gray-200 hover:border-amber-300 hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]"
        ...
        <div className="flex gap-3 sm:gap-4 justify-center items-start overflow-x-auto pb-2 reels-row">
          {INSTAGRAM_REELS.map((url, idx) => (
            <div
              key={url}
              className="reel-card rounded-2xl overflow-hidden border-2 border-gray-200 shadow-md flex-shrink-0 hover:shadow-xl hover:scale-[1.02] hover:border-amber-300 transition-all duration-300"
  ...
  <section id="offer" className="relative py-12 sm:py-14 lg:py-16 bg-white">
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      <div className="text-center mb-8 sm:mb-10">
        <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
          Полная система со скидкой <span className="accent-gradient">87%</span>
        </h2>
        <p className="mt-3 text-xs sm:text-sm text-gray-500 reveal-up" style={{animationDelay:"120ms"}}>
          Специальное предложение на этой неделе • Предложение действует ограниченное время
        </p>
      </div>

      <div className="max-w-lg mx-auto">
        <div className="rounded-3xl sm:rounded-[2rem] p-6 sm:p-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white shadow-2xl relative overflow-hidden hover:shadow-3xl transition-all duration-300 hover:scale-105 reveal-up">
          ...
          <div className="relative z-10">
            <div className="text-center">
              <div className="text-xs sm:text-sm uppercase tracking-wide text-gray-300 mb-3 sm:mb-4">
                Полный доступ
              </div>
              
              <div className="flex items-center justify-center gap-3 sm:gap-4 mb-5 sm:mb-7">
                <span className="text-gray-400 line-through text-xl sm:text-2xl">146€</span>
                <span className="text-4xl sm:text-5xl font-extrabold text-white">19€</span>
              </div>

              <div className="mb-5 sm:mb-7">
                <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-amber-600 px-4 sm:px-5 py-2 sm:py-2.5 hover:from-orange-600 hover:to-amber-700 transition-all">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="block w-full text-center rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 hover:from-amber-600 hover:via-orange-600 hover:to-amber-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl mb-4 sm:mb-5 min-h-[48px]"
                aria-label="Купить полную систему со скидкой 87% — 19 евро"
              >
                Получить со скидкой 87%
              </a>

              <div className="text-xs text-gray-300 mb-5 sm:mb-7">
                Без скрытых платежей • Пожизненный доступ • Обновления включены
              </div>

              <div className="text-left mb-5 sm:mb-7">
                <h3 className="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4 text-center">Что входит:</h3>
                <ul className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm text-gray-200">
                  {[
                    "Готовые диалоги для всех ситуаций (67€)",
  ...
  <section id="faq" className="relative py-12 sm:py-14 lg:py-16 premium-bg-2">
    <SectionMarker n="09" />
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      <h2 className="js-heading text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-8">
        Частые вопросы
      ...
      <div className="space-y-3 sm:space-y-4">
        {[
          ...
          <div key={i} className="border border-gray-200 rounded-2xl sm:rounded-3xl overflow-hidden bg-white premium-shadow hover:shadow-xl transition-all duration-300 reveal-up" style={{animationDelay:`${i*80}ms`}}>
            <button
              onClick={() => toggleFaq(i)}
            ...
            >
              <span className="font-bold text-sm sm:text-base lg:text-lg text-gray-900 pr-4">{f.q}</span>
              <span className={`w-5 h-5 text-gray-400 transition-transform flex-shrink-0 ${openFaq === i ? "rotate-180" : ""}`}>⌄</span>
            </button>
            {openFaq === i && (
              <div className="px-5 sm:px-6 lg:px-8 py-4 sm:py-5 border-t border-gray-200 bg-gray-50">
  ...
  {showStickyCTA && (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 z-50 lg:hidden shadow-2xl animate-slide-up">
      <a
        ...
        target="_blank"
        rel="noopener"
        className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-3 px-4 rounded-xl font-semibold text-sm text-center block hover:shadow-lg transition-all flex items-center justify-between min-h-[48px]"
        aria-label="Купить скрипты за 19 евро"
      >
  ...
  <style jsx>{`
    ...
    .premium-bg-1 {
      background: linear-gradient(to bottom right, rgb(248 250 252) 0%, rgb(255 255 255) 50%, rgb(249 250 251) 100%);
    }

    .premium-bg-2 {
      background: linear-gradient(to bottom, rgb(255 255 255) 0%, rgba(251, 243, 219, 0.15) 50%, rgb(255 255 255) 100%);
    }

    .premium-bg-3 {
      background: linear-gradient(to bottom right, rgba(236, 253, 245, 0.4) 0%, rgba(209, 250, 229, 0.3) 50%, rgba(167, 243, 208, 0.2) 100%);
    }

    .premium-bg-4 {
      background: linear-gradient(to bottom right, rgb(255 255 255) 0%, rgba(239, 246, 255, 0.3) 50%, rgb(255 255 255) 100%);
    }

    .premium-bg-5 {
      background: linear-gradient(to bottom right, rgba(239, 246, 255, 0.3) 0%, rgba(254, 242, 242, 0.2) 25%, rgba(254, 243, 199, 0.25) 100%);
    }

    .premium-bg-6 {
      background: linear-gradient(to bottom, rgb(248 250 252) 0%, rgb(241 245 249) 50%, rgb(255 255 255) 100%);
    }

    .accent-text {
      background: linear-gradient(135deg, #b45309 0%, #ea580c 50%, #b45309 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
    }
